...
// interface MonthViewCalendarProps extends AdminReducerProps {
//     venueId: number | null;
// }
...
// }) => {
//     if (!venueId) {
//         return <p>Please select a venue to view the schedule.</p>;
//     }

//     const { data: scheduledEvents } = useQuery(scheduledEventsQuery(venueId));
//     console.log(scheduledEvents?.bookings);

//     const eventDates =
//         scheduledEvents?.bookings
//             ?.flatMap((b) =>
//                 eachDayOfInterval({
...
//                             type="button"
//                             onClick={() =>
//                                 dispatch({ type: "setDay", value: day })
//                             }
...
//                                 dayIdx === daysInMonth.length - 7 &&
//                                     "rounded-bl-lg",
//                                 dayIdx === daysInMonth.length - 1 &&
//                                     "rounded-br-lg"
//                             )}
//                         >
//                             <time
